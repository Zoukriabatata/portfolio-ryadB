...
export default function ZoomControls({ onZoomIn, onZoomOut, onResetView, onScreenshot, theme }: ZoomControlsProps) {
  return (
    <div
      className="absolute bottom-4 right-4 flex items-center gap-1 p-1 rounded-xl z-15"
      style={{
    ...
    >
      <button
        onClick={onZoomIn}
        className="w-7 h-7 rounded-lg flex items-center justify-center transition-all hover:scale-110 hover:bg-white/5 active:scale-95"
