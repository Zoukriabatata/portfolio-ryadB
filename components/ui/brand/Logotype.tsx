...
/** Logotype « senz⊛ukria » : le « o » est l'atome (anneau blanc + orbite/électron néon). */
        ...
        <svg viewBox="0 0 40 40" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
          ...
          <g filter="url(#neon)">
            <g transform="rotate(-26 20 20)">
              <ellipse cx="20" cy="20" rx="17" ry="6" fill="none" stroke="#4ade80" strokeOpacity="0.9" strokeWidth="1.5" />
              <circle r="2.4" cx={anim ? 0 : 3} cy={anim ? 0 : 20} fill="#86efac">
