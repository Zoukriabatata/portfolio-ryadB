      ...
      >
            ...
            >
              {TIMEFRAMES.map(tf => (
                <button
                  ...
                  style={{
                    color: tf.sec === timeframe ? '#4ade80' : 'rgba(255,255,255,0.6)',
        ...
        {(['auto', 'on', 'off'] as FootprintMode[]).map(m => (
          <button
            ...
            style={{
              background: fpMode === m ? 'rgba(74,222,128,0.15)' : 'transparent',
              color: fpMode === m ? '#4ade80' : 'rgba(255,255,255,0.4)',
        ...
        <button
          ...
          className="px-1.5 py-0.5 rounded text-[9px] font-mono font-bold transition-colors"
          style={{
            background: features.showCVDPanel ? 'rgba(74,222,128,0.15)' : 'transparent',
            color: features.showCVDPanel ? '#4ade80' : 'rgba(255,255,255,0.35)',
          }}
                ...
                return (
                  ...
                  >
                    <span style={{
                      ...
                      border: `1px solid ${active ? '#4ade80' : 'rgba(255,255,255,0.2)'}`,
                    }} />
                    {t.label}
                  </button>
                );
        ...
        <button
          ...
          style={{ color: showSettings ? '#4ade80' : 'rgba(255,255,255,0.3)' }}
