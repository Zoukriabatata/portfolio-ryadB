...
const SHORTCUTS = [
  ...
  { key: 'Ctrl + ←', desc: 'Step back 1 candle' },
  { key: 'Ctrl + →', desc: 'Step forward 1 candle' },
  { key: '↑', desc: 'Previous bookmark' },
  { key: '↓', desc: 'Next bookmark' },
  { key: 'Home', desc: 'Jump to start' },
  { key: 'End', desc: 'Jump to end' },
