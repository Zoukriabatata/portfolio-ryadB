...
export const DATA_FEED_PROVIDERS: DataFeedProviderInfo[] = [
  ...
  // ── Gateway / Multi-Asset ────────────────────
  {
    ...
    markets: ['CME', 'CBOT', 'NYMEX', 'COMEX', 'ICE'],
    features: ['Ultra-low latency execution', 'Level 2 DOM (market depth)', 'Trade tape streaming', 'Direct exchange access'],
    connectionType: 'Gateway (R | Protocol)',
    pricingNote: 'Included with compatible broker — requires funded account',
    docsUrl: 'https://www.rithmic.com/',
    requiresCredentials: true,
    fields: [
  ...
  },
  {
    ...
    markets: ['CME', 'CBOT', 'NYSE', 'NASDAQ', 'CBOE'],
    features: ['Multi-asset coverage', 'Level 2 DOM', 'Options chain with Greeks', 'Global exchange access'],
    connectionType: 'TWS Gateway API',
    pricingNote: 'Market data subscriptions via IBKR — $1–10/mo per exchange',
    docsUrl: 'https://interactivebrokers.github.io/tws-api/',
    requiresCredentials: true,
    fields: [
      { key: 'host', label: 'TWS Host', type: 'text', placeholder: '127.0.0.1' },
      { key: 'apiKey', label: 'Port', type: 'text', placeholder: '7497' },
    ],
  },
  {
    id: 'cqg',
    ...
    features: ['Institutional-grade data', 'Level 2 DOM (market depth)', 'Options chain support', 'Direct exchange connectivity'],
    connectionType: 'CQG Web API',
    pricingNote: 'Bundled with CQG subscription — contact broker for pricing',
    docsUrl: 'https://www.cqg.com/',
    requiresCredentials: true,
    fields: [
      { key: 'username', label: 'CQG Username', type: 'text', placeholder: 'CQG username' },
      { key: 'password', label: 'CQG Password', type: 'password', placeholder: 'CQG password' },
    ],
  },
  {
    id: 'amp',
    ...
    markets: ['CME', 'CBOT', 'NYMEX', 'COMEX', 'ICE'],
    features: ['Ultra-low commissions', 'Multi-platform support', 'Level 2 DOM', 'Direct market access'],
    connectionType: 'Via CQG / Rithmic',
    pricingNote: 'From $0.25/side — data fees via CQG or Rithmic',
    docsUrl: 'https://www.ampfutures.com/',
    requiresCredentials: true,
    fields: [
      { key: 'username', label: 'Username', type: 'text', placeholder: 'AMP username' },
      { key: 'password', label: 'Password', type: 'password', placeholder: 'AMP password' },
      {
        key: 'host',
        label: 'Data Feed',
        type: 'select',
