 ...
 * RAY TOOL DEFINITION
 *
 * Ray is a trendline variant with extendRight=true.
 * At runtime, it stores type='trendline' but is created via 'ray' in the UI.
 */
...
const rayDefinition: ToolDefinition<TrendLineTool> = {
  type: 'ray',
  minPoints: 2,
  defaultStyle: { color: '#8b5cf6', lineWidth: 2, lineStyle: 'solid' },
  ...
  // Ray shares all behavior with trendline once created
...
toolRegistry.register(rayDefinition);
export default rayDefinition;
