      ...
      <div className="max-w-2xl mx-auto">
        ...
        {step === 1 && (
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-8">
            ...
            <button
              onClick={() => setStep(2)}
              className="mt-6 w-full py-3 bg-gradient-to-r from-[#16a34a] to-[#4ade80] text-white font-semibold rounded-lg hover:opacity-90 transition-opacity"
            >
        ...
        {step === 2 && (
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-8">
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button
                onClick={() => setStep(3)}
                className="flex-1 py-3 bg-gradient-to-r from-[#16a34a] to-[#4ade80] text-white font-semibold rounded-lg hover:opacity-90 transition-opacity"
              >
                Got it &rarr;
              </button>
            </div>
